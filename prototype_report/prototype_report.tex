...
\label{sub:required_features}

The application should be able to:

\begin{itemize}
\item Allow the user to authenticate into the application with the same credentials as their ADU account.
\item Allow the user to create new record for any one of the ADU databases, the records should hold the exact same information as they would if they were created on the ADU.
\item Automatically complete data where possible, such as location and date.
\item Allow the user to override any auto completed data.
\item Allow the user to submit completed record to the ADU for verification.
\item Allow the user to edit/delete any non-submitted records and view any previously submitted records.
\item Allow the user the option to only upload records when on wi-fi.
\end{itemize}

% section required_features (required_features)
...
\begin{figure}[htb]
\centering 
\includegraphics[width=1.0\columnwidth]{UseCase} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=1.0\columnwidth]{Login} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=1.0\columnwidth]{AddEditRecord} 
...
\begin{figure}[htb]
\centering 
\includegraphics[width=1.0\columnwidth]{Hamburger} 
